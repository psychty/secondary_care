...
AND EPIORDER = 1
-- Any Local Authority in England or No fixed abode
AND RESLADST_ONS RLIKE ('E|U')
-- Injury anywhere in diagnoses fields
AND (DIAG_3_CONCAT RLIKE ('[ST]') AND DIAG_3_CONCAT RLIKE ('W[01]'))
