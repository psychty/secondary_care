...
AND RESLADST_ONS RLIKE ('E|U')
GROUP BY Financial_year)
UNION(SELECT FYEAR AS Financial_year, SUM(FAE) 
...
--- LSOA Level data for England ---

SELECT LSOA11CD, Age_group, (FY_2223), (FY_2122), (FY_2021), (FY_1920), (FY_1819)
FROM((SELECT
CASE WHEN FYEAR = 1819 THEN 'FY_1819' 
    WHEN FYEAR = 1920 THEN 'FY_1920' 
    WHEN FYEAR = 2021 THEN 'FY_2021'
    WHEN FYEAR = 2122 THEN 'FY_2122'
    WHEN FYEAR = 2223 THEN 'FY_2223' 
    ELSE FYEAR 
...
-- England and Unknown LAD only
AND RESLADST_ONS RLIKE ('E|U')
GROUP BY Financial_year, LSOA11CD, Age_group)
UNION
(SELECT
CASE WHEN FYEAR = 1819 THEN 'FY_1819' 
    WHEN FYEAR = 1920 THEN 'FY_1920' 
...
PIVOT (
    MAX(Admissions)
    FOR Financial_year IN (('FY_2223'), ('FY_2122'), ('FY_2021'), ('FY_1920'), ('FY_1819'))
);