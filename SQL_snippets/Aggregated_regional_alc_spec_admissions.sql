...
FROM (
    ...
    -- England overall (includes unknown and no fixed abode)
    ...
    (
        SUM(FAE)
        FOR Financial_year IN (('FY_201415'), ('FY_201516'), ('FY_201617'),('FY_201718'), ('FY_201819'), ('FY_201920'),('FY_202021'), ('FY_202122'), ('FY_202223'))
    )
